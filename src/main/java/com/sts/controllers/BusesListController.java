...
public class BusesListController {
	
	@RequestMapping(value = "/buses_list", method = RequestMethod.GET)
	public ModelAndView busesListHome(ModelAndView model,
			HttpServletRequest request) {
		Authentication auth = SecurityContextHolder.getContext()
				.getAuthentication();
		model.setViewName("/school_admin/buses_list");
