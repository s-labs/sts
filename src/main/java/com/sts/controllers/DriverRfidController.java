...
public class DriverRfidController {
	@RequestMapping(value = "/drivers_rfid_list", method = RequestMethod.GET)
	public ModelAndView seniorHomePage(ModelAndView model,
			HttpServletRequest request) {
		Authentication auth = SecurityContextHolder.getContext()
				.getAuthentication();
		model.setViewName("/school_admin/drivers_rfid_list");
		model.addObject("current_page", "drivers_rfid_list");
