			...
			<div class="container">
				...
				<div class="page-header">
					...
					<div class="page-title">
						<h3>Staff List</h3>
						<span>Create,Update,Delete Staff List</span>
					</div>
					<br>
				...
				<!--=== Managed Tables ===-->
					...
					<div class="col-md-12">
						<a data-toggle="modal" href="#myModal1" class="btn btn-primary"><i
							class="icon-plus"></i></span> Add New Staff</a>
					</div>
					<br>
					<!--=== Normal ===-->
				<div class="row">
					<div class="col-md-12">
						<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>Staff List</h4>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Create New Staff Details...</h4>
				</div>
