...
public class DriversListController {
	@RequestMapping(value = "/drivers_list", method = RequestMethod.GET)
	public ModelAndView driversListHome(ModelAndView model,
			HttpServletRequest request) {
		Authentication auth = SecurityContextHolder.getContext()
				.getAuthentication();
		model.setViewName("/school_admin/drivers_list");
